...
# See https://ghproxy.com/https://github.com/cdr/code-server/blob/main/docs/install.md
...
More installation docs are at https://ghproxy.com/https://github.com/cdr/code-server/blob/main/docs/install.md
EOF
}

echo_latest_version() {
  # https://gist.github.com/lukechilds/a83e1d7127b78fef38c2914c4ececc3c#gistcomment-2758860
  version="$(curl -fsSLI -o /dev/null -w "%{url_effective}" https://ghproxy.com/https://github.com/cdr/code-server/releases/latest)"
  version="${version#https://ghproxy.com/https://github.com/cdr/code-server/releases/tag/}"
  version="${version#v}"
  echo "$version"
}
...
install_deb() {
  ...
  fetch "https://ghproxy.com/https://github.com/cdr/code-server/releases/download/v$VERSION/code-server_${VERSION}_$ARCH.deb" \
...
install_rpm() {
  ...
  fetch "https://ghproxy.com/https://github.com/cdr/code-server/releases/download/v$VERSION/code-server-$VERSION-$ARCH.rpm" \
...
install_standalone() {
  ...
  fetch "https://ghproxy.com/https://github.com/cdr/code-server/releases/download/v$VERSION/code-server-$VERSION-$OS-$ARCH.tar.gz" \
...
install_npm() {
  ...
  echoerr "See the docs https://ghproxy.com/https://github.com/cdr/code-server/blob/v3.9.3/docs/install.md#yarn-npm"
  exit 1
}
